...
class NovaVisionProvider(VisionProvider):
    ...
    def _analyze_sync(
        ...
        prompt = (
            ...
            "Analyze the media for ANY creator domain (SaaS/software, education, service, "
            "fashion, food, beauty, travel, fitness, lifestyle). Do not assume the subject is a "
            "physical skincare product. When the image is a UI screenshot, dashboard, text card, "
            "team photo, or interface, describe it in those terms. If the subject is a physical "
            "product, describe textures/materials; otherwise leave texture and sensory fields "
            "empty or use 'not_applicable'.\n"
            "- color_palette: List the 3-5 dominant colors as descriptive names "
            "(e.g. 'navy_blue', 'soft_gray', 'warm_beige', 'sage_green').\n"
            "- lighting_type: Describe the lighting setup "
            "(e.g. 'natural_window_light', 'screen_glow', 'studio_softbox', 'mixed').\n"
            "- texture_descriptors: List visible physical textures ONLY when a physical product "
            "or skin is central (e.g. 'matte_paper', 'glossy_screen', 'woven_fabric', "
            "'natural_wood'). For screenshots, dashboards, and text cards return [].\n"
            "- shooting_angle: Primary camera angle "
            "(e.g. 'macro', 'overhead', '45_degree', 'eye_level', 'screen_capture').\n"
            "- aesthetic_style: Name the overall aesthetic movement "
            "(e.g. 'clean_editorial', 'minimalist_dashboard', 'street_style', "
            "'clinical_editorial', 'outdoor_lifestyle').\n"
            "- composition_style: Describe the frame composition "
            "(e.g. 'minimalist_centered', 'flat_lay', 'lifestyle_scene', "
            "'interface_screenshot', 'rule_of_thirds').\n"
            "- asmr_elements: List any sensory/ASMR-triggering visual elements ONLY when relevant "
            "(e.g. 'liquid_pour', 'texture_close_up', 'keyboard_typing'). "
            "For non-physical products return [].\n"
            "- contextual_placement: Describe the scene and the subject's role in it. "
            "Do not just list objects; explain the meaning of the scene. "
            "Examples: 'a dashboard screenshot with a highlighted metric, framed as proof of a "
            "workflow result'; 'a team member in an office, presenting the tool as part of a "
            "workday'; 'a product rests on rumpled hotel sheets beside a passport and morning "
            "coffee, framing it as a travel essential'.\n"
            "- sensory_visual_proof: List 2-5 visible cues that make the claim credible. "
            "For physical products: 'glossy bottle', 'product texture close-up', "
            "'swatch on skin'. For SaaS/education: 'annotated UI element', 'before/after metric', "
            "'real notification', 'user profile screenshot'. If none, return [].\n"
            "- aspirational_lifestyle_narrative: Describe the lifestyle the image sells in one "
            "sentence. Examples: 'a focused work session where the tool removes friction from a "
            "daily task'; 'a calm, curated morning ritual for someone who treats self-care as "
            "self-respect'.\n"
            "- visual_hook: The first-glance tension or promise. "
            "Examples: 'a bold before/after metric on a dashboard promising a measurable result'; "
            "'a drop of serum about to fall onto sun-warmed skin, promising visible freshness'.\n"
            "- material_context: Surface, scale, and object relation. "
            "For software, describe screen/chrome or environment; for physical product, physical "
            "material. Examples: 'browser window with clean sans-serif typography on a muted gray "
            "dashboard'; 'frosted glass jar held against bare shoulder, matte label catching "
            "window light'.\n\n"
            "STRATEGIC RULES:\n"
            ...
            "- Do not assume skincare, beauty, or cosmetics unless the image explicitly "
            "contains them.\n"
            "- Frame the subject as an actor in a relevant scene or narrative, not a clinical "
            "object.\n\n"
            f"Schema:\n{schema}\n\n"
